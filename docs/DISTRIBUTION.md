...
- WiX/MSI permits only numeric prerelease identifiers. The product release `1.0.0-rc.1` therefore uses native bundle version `1.0.0-1`; release notes and tags retain the human-readable RC label.

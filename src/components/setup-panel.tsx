  ...
  return (
    <section className="content-grid">
      ...
      <StatusCard
        ...
        detail={props.magentOk ? (props.system?.contracts?.task?.version === "magent.task.v2" ? "Stable task-v2 desktop contracts negotiated" : "Desktop APIs ready; contract negotiation unavailable") : "Install or upgrade before using desktop-only flows"}
        action="Detect"

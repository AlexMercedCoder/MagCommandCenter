      ...
      <div className="panel browser-hero">
        <div>
          ...
          <p>
            ...
            and keep inbox or merge workflows tucked into focused drawers.
          </p>
        </div>
        ...
        <div className="panel browser-sidebar">
          ...
          <div className="control-row">
            <input
              ...
              placeholder="Search memories, tags, or project facts"
            />
            <button
        ...
        <div className="panel browser-main">
          ...
          <div className="control-row">
            <input
              ...
              onChange={(event) => props.setSelectedNodeId(event.target.value)}
              placeholder="Paste a node ID to inspect directly"
            />
            <button
              className="icon-action"
              onClick={() => props.onLoadNode()}
          ...
          <textarea
            ...
            onChange={(event) => props.setEditBody(event.target.value)}
            placeholder="Select a node to inspect or edit its Markdown body."
          />
        ...
        <div className="browser-side-stack">
          ...
          <details className="panel inline-details" open>
            ...
            <div className="stack">
              ...
              <input
                id="memory-improve"
                value={props.improvePrompt}
                onChange={(event) => props.setImprovePrompt(event.target.value)}
              />
              ...
              <input
                ...
                onChange={(event) =>
                  props.setSuppressReason(event.target.value)
                }
              />
              <div className="row-actions">
                <button
          ...
          <details className="panel inline-details">
            ...
            <div className="stack">
              <p className="muted">
                ...
                operations as one reviewed change.
              </p>
              <textarea
  ...
  return (
    <details className="panel inline-details" open>
      ...
      <input
        ...
        onChange={(event) => props.setSelectedId(event.target.value)}
        placeholder="Candidate ID"
      />
      <textarea
        value={props.editBody}
        onChange={(event) => props.setEditBody(event.target.value)}
        placeholder="Edit candidate before promoting, or use this as a rewrite scratchpad."
      />
      <div className="row-actions">
        <button
          className="icon-action"
      ...
      {nodes.length ? (
        nodes.map((node, index) => {
          ...
          return (
            <div
              className={
                props.selectedNodeId === id ? "graph-node active" : "graph-node"
              }
              key={id}
              style={{
...
export function MemoryProvenance(props: {
  ...
  if (!props.node)
    return (
      <p className="muted">
        Inspect a node to see backlinks, links, and provenance.
      </p>
    );
  ...
  const reasons = listFromUnknown(
    props.node.reasons ?? props.node.relevance_reasons,
  );
    ...
    <div className="memory-evidence">
      ...
      {reasons.length > 0 && (
        <p className="recall-reasons">
          <strong>Why recalled:</strong> {reasons.join(" · ")}
        </p>
      )}
      {scores !== undefined && (
        <details className="score-details">
          <summary>Retrieval score</summary>
